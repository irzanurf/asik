...
<body id="page-top" style="background-image: url('<?php echo base_url('assets/background.png'); ?>');background-size: cover;">
    ...
    <img class="profile-img-card" src="<?php echo base_url('assets/avatar_2x.png'); ?>">
