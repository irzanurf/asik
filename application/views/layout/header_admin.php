...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#sempro" aria-expanded="true"
                    aria-controls="sempro">
                    <i class="fas fa-fw fa-car"></i>
                    <span>Manajemen Kendaraan</span></a>
                </a>
                <div id="sempro" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/daftar_sepeda');?>"><i
                                class="fas fa-fw fa-bicycle"></i> Sepeda</a>
                        <a class="collapse-item" href="<?= base_url('admin/daftar_bus');?>"><i
                                class="fas fa-fw fa-bus"></i> Bus</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#ujian" aria-expanded="true"
                    aria-controls="ujian">
                    <i class="fas fa-fw fa-history"></i>
                    <span>Aktivitas Peminjaman</span></a>
                </a>
                <div id="ujian" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/aktivitas_sepeda');?>"><i
                                class="fas fa-fw fa-bicycle"></i> Sepeda</a>
                        <a class="collapse-item" href="<?= base_url('admin/aktivitas_bus');?>"><i
                                class="fas fa-fw fa-bus"></i> Bus</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('common/not_found');?>">
